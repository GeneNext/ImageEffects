...
public class AutoCamera : MonoBehaviour
{
    ...
    private float m_fixedAxisX = 45;
    [SerializeField, Range(0f, 360f)]
    private float m_fixedAxisY = 45;

    [SerializeField]
    private bool m_smoothFollow = true;

    [SerializeField]
    private LayerMask m_targetLayer = 0;
    [SerializeField]
    private bool m_canSelectTarget = true;
    ...
    private void CheckCameraDistance()
    {
        ...
        RaycastHit hit;
        if (Physics.SphereCast(ray, Mathf.Clamp(m_cameraHeight - 0.5f, 0.01f, 1f), out hit, m_cameraDistance, m_collisionLayer))
        {
