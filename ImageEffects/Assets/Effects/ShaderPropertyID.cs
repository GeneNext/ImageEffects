...
public static class ShaderPropertyID
{
    ...
    public static int SamplerDistance;
    public static int SamplerStrength;
    ...
    static ShaderPropertyID()
    {
        ...
        SamplerDistance = Shader.PropertyToID("_SamplerDistance");
        SamplerStrength = Shader.PropertyToID("_SamplerStrength");
    }
}
